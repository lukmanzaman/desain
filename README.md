# Museum of Design & Applied Arts

Visual Infographic Museum & Continuous Reading Stream.

- **GitHub Repository**: [http://github.com/lukmanzaman/desain](http://github.com/lukmanzaman/desain)
- **Total Visual**: 1,491 poster infografis beresolusi tinggi (format JPG rasio 1:3).
- **Struktur Kurikulum**: 10 Paviliun Utama.
